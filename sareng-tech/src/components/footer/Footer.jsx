...
const Footer = () => {
  return (
    <footer className="w-full mt-16 mb-4 rounded-md p-4 shadow-lg shadow-primary">
      <div className="">
        <div className="grid grid-cols-12 gap-8 py-6 lg:grid-cols-8">
          <div className="mb-0 col-span-full lg:col-span-2 ">
            <Link to="/" className="flex justify-center md:justify-start">
              <img className="w-3/5" src="./logo.png" alt="logo" />
            </Link>
            <p className="py-8  text-gray-500 lg:max-w-xs text-center lg:text-left">
              Trusted in more than 100 institutions & 5 million trainnes. Follow
              us on social media.
            </p>
          ...
          <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
            ...
            <ul className="text-gray-600  transition-all duration-500">
              <li className="mb-4">support@sarengTech.com</li>
              <li className="mb-4">+801767326285</li>
              <li>61-A, Disan Tower, Tetulia, Panchagarh.</li>
            </ul>
          </div>
          <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-2">
            <h4 className="text-lg text-gray-900 font-medium mb-4">Courses</h4>
            <ul className="text-gray-600 transition-all duration-500  ">
              <li className="mb-4">
                <a
                  href="javascript:;"
          ...
          <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
            ...
            <div className="flex flex-col items-center lg:items-start">
              <input
                type="text"
                className="w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-gray-800 mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-primary"
        ...
        <div className="py-3 border-t border-primary">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-gray-500 ">
              ©<a href="#">sarengTech</a> 2024, All rights reserved.
            </span>
